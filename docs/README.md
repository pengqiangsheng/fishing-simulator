...
> 星露谷物语Stardew Valley是由ConcernedApe开发一款独立游戏。
...
**必选参数 :** `username`: 邮箱账号 `password`: 密码
...
```js
{
   "code": 200,
   "msg": "登录成功",
   "token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJuYW1lIjoicHFzIiwiaWF0IjoxNTg2MDU2MDU1LCJleHAiOjE1ODYwNTk2NTV9.Tku09iis6sLr9btarMb5uGZ71k0YP7rVB7YgpHlscIo"
}
```
...
调用登录注册接口的速度比调用其他接口慢 , 因为此过程调用了加密算法
...
[The MIT License (MIT)](https://github.com/pengqiangsheng/fishing-simulator/blob/master/LICENSE)
